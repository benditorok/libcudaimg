...
namespace exports
{
	...
	/// <summary>
	/// Exposed function which calls the gaussianBlur kernel.
	/// </summary>
	/// <param name="image">Pointer to the first byte of the image.</param>
	/// <param name="image_len">The number of bytes in the image.</param>
	/// <param name="width">The width of the image, should be multiplied by 3 if it's in an RGB format.</param>
	...
	/// <summary>
	/// Exposed function which calls the sobelEdgeDetection kernel.
	/// </summary>
	/// <param name="image">Pointer to the first byte of the image.</param>
	///	<param name="image_len">The number of bytes in the image.</param>
	/// <param name="width">The width of the image, should be multiplied by 3 if it's in an RGB format.</param>
	...
	/// <summary>
	/// Exposed function which calls the laplaceEdgeDetection kernel.
	/// </summary>
	/// <param name="image">Pointer to the first byte of the image.</param>
	///	<param name="image_len">The number of bytes in the image.</param>
	/// <param name="width">The width of the image, should be multiplied by 3 if it's in an RGB format.</param>
	...
	/// <summary>
	/// Exposed function which calls the harrisCornerDetection kernel.
	/// </summary>
	/// <param name="image">Pointer to the first byte of the image.</param>
	///	<param name="image_len">The number of bytes in the image.</param>
	/// <param name="width">The width of the image, should be multiplied by 3 if it's in an RGB format.</param>
